...
@IBDesignable public class RSKPlaceholderTextView: UITextView {
    ...
    private func commonInitializer() {
        contentMode = .TopLeft
        NSNotificationCenter.defaultCenter().addObserver(self, selector: "RSKPlaceholderTextView.handleTextViewTextDidChangeNotification(_:)", name: UITextViewTextDidChangeNotification, object: self)
    }
